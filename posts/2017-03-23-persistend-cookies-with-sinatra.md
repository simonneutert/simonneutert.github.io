...
_You can find the implementation in the Sinatra MVC App i put together on my
github account._

Badosus Example worked nearly out of the box in my Sinatra App
(Username/Password auth already -
[read more](https://github.com/sklise/sinatra-warden-example)). I had to modify
the code just a little. Make sure to set your cookies like in my example above
and provide a proper `fail!` in your
...
I pulled off a customized "remember me" login option with a cookie-based user
authentication option, thanks to these wonderful docs, blogs and gists.
