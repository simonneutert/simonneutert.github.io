...
Recursive Function Calls or Functional Programming as a concept can be quite
...
Functional Programming means a function may return a function. To get an idea of
what is going on behind the curtains - visualizing functions helps me.
