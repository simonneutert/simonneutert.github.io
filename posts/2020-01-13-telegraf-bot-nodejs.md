...
Bots, they are everywhere, right? Why not have a bot, that's doing some fancy
work for you?

Telegrams 'BotFather' is the way to get you started:
[see the docs](https://core.telegram.org/bots#6-botfather)

It is as easy as open telegram, search @botfather and send him `/newbot` as a
message, few more steps like naming aaaand boom - bot is up!

**DISCLAIMER** The following code is a quick and dirty solution! It is simply
sending me memes from subreddit 'ProgrammerHumor'.\
Checkout my
[reddit-api-image-getter](https://www.npmjs.com/package/reddit-api-image-getter)
package on npm.

Want to know what
[telegraf](https://github.com/telegraf/telegraf/blob/develop/docs/examples/media-bot.js)
does?\
Telegraf does not explicitely tell, but adding a caption to a photo is added in
...
Grab your phone, start your bot and send `/refresh` watch the picture pop up on
your filesystem, then send `/makemehappy` and have a laugh.

Send me a message on telegram and chat with me, best let me know what kind of
bot you brought to life: [https://t.me/simonneutert](https://t.me/simonneutert)
