...
asdf is now known as asdf-vm (asdf version manager) and you can check the
[website](https://asdf-vm.com/#/) or jump to the
[code base on GitHub](https://github.com/asdf-vm/asdf).
...
It is installed really quick and will do all the hustle for you. User of Mac OS
Catalina which comes with `zsh` as the default shell will most likely use
oh-my-zsh and all you need to do is enable the plugin.
...
when it comes to installing nodejs, there might be an error, which is easily
fixed by hacking this into your terminal:
