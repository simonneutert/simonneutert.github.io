...
The guys from [Städler Made](https://www.stadlermade.com/) provide excellent
recipes AND OVENS!

So much so, that I was scared they change something and I am lost in the search
for the recipe I got to love so much!

Having permission to have the code public from Sanne and Pieter, I am very proud
to show my Clojurescript take on the recipe we ever since love so much 🥰

Project on GitHub:
[pizza-dough-calculator](https://github.com/simonneutert/pizza-dough-calculator)

The scope of the app is both showing of how nice developing with Clojurescript
can be.
