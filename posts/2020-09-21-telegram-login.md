...
have ngrok installed and start a server by `$ ngrok http -p 5555` and copy the
https url you are given

- see what .env.example ships with and create a `.env` (copy of .env.example)
