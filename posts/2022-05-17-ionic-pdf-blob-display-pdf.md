...
Ionic Vue and Cordova and Capacitor and the framework you ended to pick for the
frontend can be pretty overwhelming to google...
...
in your component you should add two methods, covering the platforms web (for
debugging) and app platforms
