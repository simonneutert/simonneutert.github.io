...
It is a simple CLI that is built with [Deno](https://www.deno.com) and uses
[ink](https://github.com/vadimdemedes/ink) for the CLI.
...
Do you find yourself in a situation, where you ask the AI questions in a
thread-like manner?\
...
In order to use Wilson, you need to provide a JSON file that contains the recipe
for the assistant.
...
☝️ this recipe is used to create further assistants using AI itself. Inception,
right? 😵‍💫

## Source Code on GitHub

The source code is available on GitHub:
[wilson](https://github.com/simonneutert/wilson).
