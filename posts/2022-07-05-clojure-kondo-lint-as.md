...
This is how you make kondo shut up about faulty `let` declarations, in specific
[nbb](https://github.com/babashka/nbb) and
[promesa](https://github.com/funcool/promesa)

What is [promesa](https://github.com/funcool/promesa)? Glad you ask:

> A lightweight promise/future library for Clojure & ClojureScript built on top
> of native primitives (js/Promise on JS, and `CompletableFuture` on
> JVM).<span>https://github.com/funcool/promesa</span>
