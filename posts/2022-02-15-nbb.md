...
babashka and nbb feel like they gain momentum, so I chose nbb and dabbled a
little.

What I got, was an easy to use Screenshot Tool I can run from the terminal.

You can find the repo
[here, on GitHub](https://github.com/simonneutert/nbb-screenshot).

The project relies on `playwright` and Node's `ArgumentParser` and of course
`nbb`.
