...
[on StackOverflow](http://stackoverflow.com/a/24650062/6601963), there they say
that:

> When dealing with ActiveRecord there's a significant difference too: dup
> creates a new object without its id being set, so you can save a new object to
> the database by hitting `.save`
