...
Let's say you can clean up some queries. Use
[AREL](https://github.com/rails/arel)'s magic by utilizing Rails'
[arel_table](https://apidock.com/rails/ActiveRecord/Core/ClassMethods/arel_table)
method.
...
Do not forget:
[Scopes](http://guides.rubyonrails.org/active_record_querying.html#scopes) can
