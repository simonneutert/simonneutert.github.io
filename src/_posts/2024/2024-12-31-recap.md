...
Overall I'm happy with the progress I made. I've made some new friends along the way and I've been able to help some people with their projects.
...
_Bonus:_ experimenting with JavaScript Runtimes played a huge part this year:
...
### Unreachable Tiles Map Editor (Deno)
...
### Deno Garmin JS SDK to JSON (Deno)
...
### Strava Export Organizer Web w/ CLI (Ruby and Go)
...
- Ruby stuff:
  ...
  - jemalloc2 and ruby
- Traefik and cron jobbed deploys from GHCR
