...
Setting up OpenCloud in my home network was a learning experience. I wanted a simple, private installation using local DNS and self-signed certificates. Here's how I did it with Pi-hole and Caddy.
...
Edit `.env` and update these critical paths (replace `bedman` with your username):
